...
public class HexTile
{
  ...
  public void ChangeType(TileType t)
  {
	...
	uvs [(int)hexagon.uv1i] = WorldRenderer.uv1 + newOffset;
	uvs [(int)hexagon.uv2i] = WorldRenderer.uv2 + newOffset;
	uvs [(int)hexagon.uv3i] = WorldRenderer.uv3 + newOffset;
	uvs [(int)hexagon.uv4i] = WorldRenderer.uv4 + newOffset;
	uvs [(int)hexagon.uv5i] = WorldRenderer.uv5 + newOffset;
	uvs [(int)hexagon.uv6i] = WorldRenderer.uv6 + newOffset;
	mesh.uv = uvs;
  }
